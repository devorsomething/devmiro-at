...
const services = [
  ...
  },
  {
    icon: Share2,
    title: 'Social Media',
    desc: 'Instagram, Facebook und TikTok Content & Management. Regelmäßig, professionell und engagement-stark — ohne dass Sie selbst posted.',
  ...
  },
  {
    ...
    desc: 'Managed Hosting direkt in Österreich — SSL, Updates, Backup und Monitoring inklusive. Ihr Server läuft, Sie können sich auf Ihr Business konzentrieren.',
  ...
  },
  {
    ...
    desc: 'Automatisierte E-Mail Kampagnen für Vorarlberger Unternehmen — Newsletter, Follow-up Sequences und Lead Nurturing.',
  ...
  },
  {
    icon: Search,
    title: 'Google Ads',
    desc: 'ROI-getrackte Google Ads Kampagnen, die echte Kunden bringen. Pay-per-Click mit transparentem Reporting und kontinuierlicher Optimierung.',
  ...
  },
  {
    icon: ShoppingCart,
    title: 'Online Shop',
    desc: 'E-Commerce mit Shopify oder WooCommerce — von der Einrichtung bis zum Go-Live. Inklusive Design, Zahlungsanbindung und Schulung.',
  ...
  },
  {
    icon: Headphones,
    title: 'IT-Support',
    desc: '24/7 IT-Helpdesk für Ihr Büro — von Software-Problemen bis zur Netzwerkwartung. Fester Ansprechpartner, schnelle Reaktionszeiten.',
