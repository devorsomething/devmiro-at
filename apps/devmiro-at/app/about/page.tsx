            ...
            <div className="about-grid">
              <div>
                ...
                <p className="section-subtitle" style={{ maxWidth: '100%', marginTop: 'var(--space-4)' }}>
                  ...
                  Ergebnisse, die man messen kann: mehr Buchungen, mehr
                  Anfragen, mehr Umsatz.
                </p>
                <p className="section-subtitle" style={{ maxWidth: '100%', marginTop: 'var(--space-4)' }}>
              ...
              >
                <div>
                  ...
                  <div style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>
                    Vorarlberg-fokussiert — keine Callcenter, keine
                    Warteschleifen. Sie sprechen direkt mit mir.
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>
                    Jedes Projekt wird von Grund auf DSGVO-konform
                    umgesetzt — kein nachträgliches Patchwork.
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>
                    Reaktionszeit bei Anfragen. Ich bin erreichbar, wenn Sie
                    mich brauchen — nicht nur auf Papier.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div style={{ maxWidth: '720px', margin: '0 auto' }}>
              ...
              >
                ...
                >
                  ...
                  E-Commerce greife ich auf Shopify zurück — das umfangreichste
                  und sicherste Shop-System am Markt.
                </p>
              </div>
            </div>
          </div>
